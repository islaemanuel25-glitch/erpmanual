...
// Esta pantalla es la que vivía en `/modulos/configuracion/pos-ventas`. Se mudó
// entera —mismo archivo, movido con `git mv`— cuando esa ruta pasó a ser la
// portada de Configuración POS. Lo único que cambió es el título: la lógica de
// los toggles no se tocó y no está duplicada en ningún lado.
export default function ConfigPosReglasPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <SunmiHeader
        ...
        subtitle="Configuración POS · Cliente, operario y stock a la vista."
      />
