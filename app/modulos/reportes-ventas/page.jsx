...
export default function ReportesVentasPage() {
  ...
  // ── ACÁ HUBO UN INTERRUPTOR "VER TAMBIÉN LAS INTERNAS". SE SACÓ ───────────
  //
  // Existió unas horas el 2026-08-20 y se retiró el mismo día por decisión de
  // producto. Lo había puesto para llegar al botón de anular una venta interna,
  // pero eso partía de una premisa equivocada: **una transferencia mal enviada
  // se corrige desde Transferencias**, que es el documento que el local destino
  // recibe y revisa. Ventas no tiene por qué ser el camino.
  //
  // Se anota para que no vuelva: si alguien necesita ver una operación interna,
  // la pregunta correcta no es "cómo la muestro en el listado comercial" sino
  // "qué le falta al módulo de Transferencias".
