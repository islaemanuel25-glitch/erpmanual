...
import usePedidosProveedor, { ESTADOS_ACTIVOS } from "@/components/compras-proveedor/usePedidosProveedor";
...
export default function PedidosActivosPage() {
  ...
  const renderAccion = (item) => {
    ...
    return (
      ...
      >
        {item.estado === "CONFIRMADO" ? "Ver / enviar" : "Ver"}
      </SunmiButton>
    );
  };
      ...
      <SunmiCard>
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="min-w-0">
            <SunmiHeader title="Pedidos activos" />
            <p className="text-xs sunmi-text-muted px-1">Pedidos pendientes de gestión</p>
          </div>
        ...
        <FiltrosPedidosProveedor
          estadoOpciones={ESTADOS_ACTIVOS}
          estadoTodosLabel="Todos los activos"
          estado={estado}
          onEstado={setEstado}
