...
export default function AparienciaPage() {
  ...
  const { sidebarMode, setSidebarMode, sidebarGroup, setSidebarGroup } = useSidebarConfig();
    ...
    <div className="w-full min-h-full">
      <SunmiCard>
        <SunmiCardHeader
          ...
          subtitle="Configurá tamaño, layout y theme de la interfaz Sunmi."
          color="amber"
        />

        {/* ================= TAMANO ================= */}
        <SunmiSeparator label="Tamaño del sistema" color="amber" />

        <p className="text-xs mb-3 opacity-80">
          Elegí uno de los tamaños predefinidos. No se editan valores manuales:
          solo presets seguros del sistema.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
          {[
            { id: "icons", label: "Solo iconos", description: "Sidebar compacto con iconos únicamente." },
            { id: "icons-text", label: "Iconos + texto", description: "Sidebar expandido con iconos y nombres." },
          ].map((opt) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
          {[
            { id: "flat", label: "Lista plana", description: "Todos los items en una lista simple." },
            { id: "grouped", label: "Agrupado", description: "Items organizados por secciones." },
          ].map((opt) => {
