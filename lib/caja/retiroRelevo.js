...
export const TITULO_PREPARAR_RETIRO = "Retiro de recaudación";
export const TITULO_RETIRO = "Retiro de recaudación";

/**
 * El aviso de la pantalla previa.
 *
 * Es el equivalente del que muestra el cierre, con la diferencia que importa: el
 * POS NO se libera y el turno sigue vendiendo. Decir lo mismo que el cierre haría
 * creer que la caja se termina acá.
 */
export const AVISO_ANTES_DEL_RETIRO =
  "Al iniciar el retiro se hará un corte de este turno. La caja sigue vendiendo con el cambio que separes, y las operaciones posteriores no formarán parte de este retiro.";

/** El botón de la pantalla previa. NO corta: abre el modal del cambio. */
export const ACCION_ABRIR_CAMBIO_RETIRO = "Iniciar retiro";
