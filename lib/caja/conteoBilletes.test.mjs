...
test("10b. no existe el billete de $5.000 y no está en la lista", () => {
  // El BCRA emitió $2.000, $10.000 y $20.000 sobre la familia previa. No hay
  // $5.000: incluirlo sería una fila que nadie usa.
  const valores = DENOMINACIONES.map((d) => d.valor);
  assert.ok(!valores.includes(5000), "se coló un billete inexistente");
  assert.deepEqual(valores, [20000, 10000, 2000, 1000, 500, 200, 100]);
  // Y están ordenadas de mayor a menor, como se cuenta en la práctica.
