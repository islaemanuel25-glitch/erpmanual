 ...
 *
 * No es una comodidad: sin esta excepción la operación de desvincular no puede
 * existir. Esa operación cancela la transferencia y cambia el cliente en la misma
 * transacción, y el orden no la salva —da igual qué se escriba primero, la venta
 * termina con una transferencia cancelada y cualquier corrección posterior de esa
 * venta quedaría prohibida para siempre por un remito que ya no significa nada.
 *
