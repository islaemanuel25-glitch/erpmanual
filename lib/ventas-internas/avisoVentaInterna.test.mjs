...
import { esComentario } from "../hardcodeo/contador.mjs";
...
// `--others --exclude-standard`: un consumidor nuevo sin commitear no está en el
// índice, así que `git ls-files` a secas no lo vería. Agujero del 2026-09-14.
const ARCHIVOS = execSync(
  "git ls-files --cached --others --exclude-standard app components lib hooks",
  {
    cwd: RAIZ,
    encoding: "utf8",
  }
