...
test("oferta: la línea se imprime al precio COBRADO y el ticket cuadra", async () => {
  ...
  assert.equal(cuenta(traza, "$900,00"), 1, "la línea tiene que decir el precio cobrado");
