...
export function resumenComercial(medio) {
  ...
  return [
    ...
    comision > 0 ? `Comisión ${formatearPct(comision)}` : "Sin comisión",
  ].join(" · ");
}
...
export function cuerpoParaGuardar(form) {
  return {
    ...
    procesador: form.procesador === "" ? null : form.procesador,
...
export function textoOrigenComision(medio) {
  ...
  return medio?.comisionOrigen === "grupo"
    ...
    : "Sin definir en el grupo · se usa el valor por defecto";
}
