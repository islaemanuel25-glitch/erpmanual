...
export default function imprimirTicketTermico(venta, ancho = 58, opts = {}) {
  ...
  const fechaStr = fechaTicket.toLocaleDateString("es-AR", { day: "2-digit", month: "2-digit", year: "numeric" });
  const horaStr = fechaTicket.toLocaleTimeString("es-AR", { hour: "2-digit", minute: "2-digit", second: "2-digit" });
