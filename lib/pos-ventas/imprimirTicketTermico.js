...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Total */
    .t-total {
      text-align: ${g(tc, "totalLabel", "textAlign") || "center"};
      margin: 6px 0;
    }
    .t-total-label {
      font-size: ${g(tc, "totalLabel", "fontSize")}px;
      font-weight: ${g(tc, "totalLabel", "fontWeight")};
      margin-top: ${g(tc, "totalLabel", "marginTop")}px;
      margin-bottom: ${g(tc, "totalLabel", "marginBottom")}px;
    }
    .t-total-monto {
      font-size: ${g(tc, "totalAmount", "fontSize")}px;
      font-weight: ${g(tc, "totalAmount", "fontWeight")};
      font-variant-numeric: tabular-nums;
      margin-top: ${g(tc, "totalAmount", "marginTop")}px;
      margin-bottom: ${g(tc, "totalAmount", "marginBottom")}px;
    }
