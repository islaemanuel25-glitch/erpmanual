...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Producto: cant x precio (izq) | subtotal (der), ligeramente indentado */
    .t-item-lr {
      display: flex;
      justify-content: space-between;
      align-items: baseline;
    ...
    .t-subtotal { font-size: 12px; margin-bottom: 1px; }

    /* Bloque TOTAL: una fila "TOTAL $" | monto, grande y negrita */
    .t-total-block {
      margin: 6px 0;
    }
    .t-total-row {
    ...
    .t-vuelto { font-size: 12px; font-weight: 700; }
