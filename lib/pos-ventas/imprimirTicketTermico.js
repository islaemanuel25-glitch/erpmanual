...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Total — franja completa de lado a lado, soporta modo invertido.
       Margen negativo horizontal compensa el padding del body para que
       el fondo negro cubra todo el ancho util del ticket. */
    .t-total {
      display: flex;
      justify-content: space-between;
      align-items: center;
      ...
      margin-bottom: ${Math.max(g(tc, "totalLabel", "marginBottom"), g(tc, "totalAmount", "marginBottom"), 6)}px;${tc.totalRowInverted ? `
      background-image: url("/ticket/black.png");
