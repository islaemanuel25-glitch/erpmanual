...
/** Quiénes pueden hacer la segunda revisión. */
export const ROLES_SEGUNDA_REVISION = Object.freeze(["DUENO", "ENCARGADO", "ADMIN"]);

export function puedeHacerSegundaRevision(rol) {
  return ROLES_SEGUNDA_REVISION.includes(String(rol || "").toUpperCase());
}
