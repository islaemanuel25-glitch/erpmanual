 ...
 *
 * POR QUÉ `compras.recibir`: medido sobre los roles reales, hoy lo tienen
 * exactamente ENCARGADO y DUEÑO_LOCAL, más Admin por su comodín. Es
 * exactamente el conjunto que Emanuel describió para la segunda revisión.
 *
 * ⚠️ Con la salvedad de que es el MISMO permiso con el que se recibe. Si algún
 * día hay que separar "recibir" de "revisar lo recibido", hace falta un permiso
 * nuevo y asignarlo; hasta entonces, quien recibe también puede revisar.
 */
export const PERMISOS_SEGUNDA_REVISION = ["compras.recibir"];
