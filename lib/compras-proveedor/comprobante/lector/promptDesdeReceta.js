...
export function instruccionesDesdeReceta(recetaCruda, { proveedorNombre = null, paginas = 1 } = {}) {
  ...
  partes.push(
    "TAREA APARTE, y hacela ANTES de mirar lo que transcribiste: contá cuántos RENGLONES DE " +
      "PRODUCTO tiene impresa la tabla de detalle del comprobante, de la primera línea de " +
      "mercadería hasta la última. Contá TODOS los renglones que veas, INCLUIDOS los que estén " +
      "borrosos, cortados o que no hayas podido transcribir. No cuentes encabezados, subtotales " +
      "ni el pie.\n\n" +
      ...
      "salteaste un renglón porque no se leía, `lineasEnElPapel` tiene que ser MAYOR que la " +
      "cantidad de elementos de `lineas`, y está bien que así sea."
  );
