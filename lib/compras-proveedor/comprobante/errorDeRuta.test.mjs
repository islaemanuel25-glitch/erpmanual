...
function rutasDelModulo() {
  const salida = execFileSync(
    "git",
    // `--others --exclude-standard`: una ruta nueva sin commitear no está en el
    // índice, así que su mensaje de error no se revisaría. Agujero del
    // 2026-09-14.
    [
      "ls-files",
      "--cached",
      "--others",
      "--exclude-standard",
      "app/api/compras-proveedor/comprobantes",
      "app/api/compras-proveedor/recetas",
    ],
