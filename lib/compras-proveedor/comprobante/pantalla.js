...
export const VOCABULARIO = Object.freeze({
  ...
  SIN_TOTAL: {
    ...
    detalle:
      "Este papel no tiene total impreso, así que la suma de las líneas no se puede " +
      "verificar contra nada y no se propone ningún costo desde acá. Es lo normal en un " +
      "remito o en una planilla de pedido. Si el papel sí tiene total y no se leyó, " +
      "probá leerlo de nuevo.",
    tono: "aviso",
    proponeCostos: false,
  },
  FUERA_DE_RECETA: {
