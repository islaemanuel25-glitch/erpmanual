...
/** Quiénes ven el aviso de la campana. */
export const ROLES_QUE_VEN_EL_AVISO = Object.freeze(["DUENO", "ADMIN"]);

export function puedeVerAvisoDePaquete(rol) {
  return ROLES_QUE_VEN_EL_AVISO.includes(String(rol || "").toUpperCase());
}
