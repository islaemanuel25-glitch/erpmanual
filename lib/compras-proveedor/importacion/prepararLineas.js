  ...
  return lineas.map((linea, indice) => {
    ...
    const propuesta = automatico
      ? proponerCantidadPedido({
          ...
          producto: automatico,
          // Si el papel no declara la unidad, se asume la del PRECIO: es la
          // única escala que el documento afirma y la única que conserva el
          // subtotal. La línea sigue pidiendo revisión.
          cantidadEn: cantidadEn ?? facturaPor,
        })
      : null;
