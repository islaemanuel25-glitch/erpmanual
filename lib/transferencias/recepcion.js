...
export function calcularAjusteOrigenUnidades({
  ...
  // Lo enviado nunca tiene sueltas: el remito salió en packs enteros.
  const envM = milesimasFisicas({ cantidad: enviada, sueltas: 0, unidad, factorPack });
...
export function validarDetalleRecepcion({
  ...
  //
  // Lo enviado nunca tiene sueltas: el remito salió en packs enteros. Lo
  // recibido sí puede tener un pack incompleto, y de ahí sale la exactitud.
  ...
  const enviadaM = milesimasFisicas({
    cantidad: res.enviada, sueltas: 0, unidad: uni.unidad, factorPack,
  });
