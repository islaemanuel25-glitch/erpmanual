...
export function valorizarDetalle(
  ...
  const cantidad =
    cantidadModo === "ENVIADA"
      ...
      // El factor sale de la BASE, no del detalle: el detalle no lo tiene, y sin
      // él las unidades sueltas de un pack incompleto no se pueden llevar a la
      // escala del costo —que es por pack—.
      : cantidadAValorizar({ ...detalle, factorPack: base?.factor_pack });
