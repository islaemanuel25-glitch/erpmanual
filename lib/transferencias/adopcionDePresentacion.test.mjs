...
test("9-11. DESPUÉS de adoptar, la misma línea muestra la ficha normal y propone 5", () => {
  ...
  //
  // El marcador era la palabra "Recibido", que es el rótulo que usa ESCRITORIO.
  // El V22 lo cambió en el teléfono por "CAJÓN x8 completos", y esta prueba monta
  // la ficha con `enHoja`. El reemplazo afirma MÁS que el anterior: no solo que
  // apareció la ficha de conteo, sino que su rótulo nombra la presentación
  // ADOPTADA —que es justamente lo que este candado vino a defender—.
  assert.ok(
    html.includes("CAJÓN x8 completos"),
    "no apareció la ficha normal rotulada en la presentación adoptada"
  );
