 ...
 * `/cobros/nuevo` y `/cobros/<clave>` heredan "Cobros" de esta misma entrada. Es
 * lo que corresponde: esas dos pantallas ya escriben su propio encabezado —"
 * Agregar medio de cobro" y el nombre del medio— y lo que el shell tiene que
 * decir arriba es de qué sección son.
 *
