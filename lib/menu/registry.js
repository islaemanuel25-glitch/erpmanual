...
//
// Convive en paralelo con `lib/menu/registry.schema.js`, que es
// la versión comercial-modular declarativa (Etapa 0). Más adelante
// ambas fuentes se fusionarán en un único registry definitivo.
// ============================================================
...
export const MENU_CONFIG = [
  // 1. INICIO
  {
    ...
    color: "gray",
    items: [{ label: "Dashboard", href: "/modulos/dashboard", icon: LayoutDashboard }],
  },
  ...
  // 2. POS VENTAS (incluye Turnos y Pedidos)
  {
    ...
    items: [
      { label: "POS Ventas", href: "/modulos/pos-ventas", permiso: "pos.usar", icon: ShoppingCart },
      { label: "Turnos", href: "/modulos/turnos", permiso: "pos.usar", icon: ClipboardList },
      { label: "Pedidos", href: "/modulos/pedidos", permiso: "pedidos.ver", localOnly: true, icon: Receipt },
      { label: "Historial Pedidos", href: "/modulos/pedidos/historial", permiso: "pedidos.ver", localOnly: true, icon: History },
    ],
  },
  ...
  // 3. STOCK (incluye Productos, Categorías, POS Transferencias)
  {
    ...
    items: [
      { label: "Stock Locales", href: "/modulos/stock_locales", permiso: "stock.ver", icon: Boxes },
      { label: "POS Transferencias", href: "/modulos/pos-transferencias", permiso: "pos_transferencias.ver", icon: Repeat },
      { label: "Productos", href: "/modulos/productos", permiso: "productos.ver", icon: Package },
      { label: "Nuevo Producto", href: "/modulos/productos/nuevo", permiso: "productos.crear", icon: PackagePlus },
      { label: "Categorías", href: "/modulos/categorias", permiso: "productos.ver", icon: Tags },
  ...
  // 4. TRANSFERENCIAS
  {
    ...
    items: [
      { label: "Transferencias", href: "/modulos/transferencias", permiso: "transferencias.ver", icon: ArrowLeftRight },
    ],
  },
  ...
  // 5. COMPRAS (incluye Proveedores)
  {
    ...
    items: [
      { label: "Compras a Proveedor", href: "/modulos/compras-proveedor", permiso: "compras.ver", icon: Truck },
      { label: "Ganancia depósito", href: "/modulos/compras-proveedor/ganancia", permiso: "compras.ver", icon: TrendingUp },
      { label: "Proveedores", href: "/modulos/proveedores", permiso: "proveedores.ver", icon: Building2 },
    ],
  },
  ...
  // 6. REPORTES (incluye Auditoría POS)
  {
    ...
    items: [
      { label: "Reportes Ventas", href: "/modulos/reportes-ventas", icon: BarChart3 },
      { label: "Auditoría POS", href: "/modulos/auditoria-pos-ventas", icon: ScanSearch },
      { label: "Clientes Analytics", href: "/modulos/clientes/analytics", permiso: "clientes.ver", icon: TrendingUp },
    ],
  },
  ...
  // 7. ADMINISTRACIÓN (Usuarios, Operadores, Roles, Clientes)
  {
    ...
    items: [
      { label: "Usuarios", href: "/modulos/usuarios", permiso: "usuarios.ver", icon: Users },
      { label: "Operadores", href: "/modulos/operadores", permiso: "usuarios.gestionar", icon: UserCircle2 },
      { label: "Roles", href: "/modulos/roles", permiso: "roles.editar", icon: ShieldUser },
      { label: "Clientes", href: "/modulos/clientes", permiso: "clientes.ver", icon: Users },
    ],
  },
  ...
  // 8. CONFIGURACIÓN (admin) — Apariencia, Stock, Ticket, Locales, Grupos
  {
    ...
    adminOnly: true,
    items: [
      { label: "Apariencia", href: "/modulos/configuracion/apariencia", icon: Palette },
      { label: "Stock", href: "/modulos/configuracion/stock", icon: Warehouse },
      { label: "Ticket", href: "/modulos/configuracion/ticket", icon: Printer },
      { label: "Locales", href: "/modulos/locales", icon: MapPin },
      { label: "Grupos", href: "/modulos/grupos", icon: Layers },
    ],
  },
];
