  ...
  // ----------------------------------------------------------
  {
    ...
    items: [
      ...
      },
      {
        ...
        // Hoy se sigue mostrando porque el filtrado de feature
        // todavía no se evalúa. Cuando se active, la default del
        // catálogo (depositoCentral=false) ocultará este item
        // salvo que el grupo lo tenga activo en su config.
