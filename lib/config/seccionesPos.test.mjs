...
test("cada una lleva a una ruta que existe en el repo", () => {
  ...
  // Apariencia enlaza la superficie que YA existía: no se creó una segunda.
  assert.equal(seccion("apariencia").href, "/modulos/configuracion/apariencia");
});
