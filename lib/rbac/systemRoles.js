...
const DUENO_LOCAL_PERMISOS = [
  ...
  "compras.crear",
  "costos.ver",
  // ── LA SEGUNDA REVISIÓN VA ACÁ Y NO EN ENCARGADO, A PROPÓSITO ──────────
  //
  // ENCARGADO tiene `compras.recibir`: es quien carga la mercadería. Darle
  // también `compras.revisar` sería dejar que se dé el visto bueno a sí mismo,
  // que es exactamente lo que la segunda revisión existe para impedir.
  //
  // Como DUEÑO_LOCAL hereda de ENCARGADO, poner esto acá es lo único que
  // separa a los dos. Si algún día se decide que el encargado también revise,
  // se sube una línea — y se pierde el control.
  "compras.revisar",
  "comprobantes.ver",
  "clientes.cc.ajustar",
  "clientes.eliminar",
