...
export const PERMISSION_REGISTRY = [
    ...
    // ── DAR DE ALTA UN PROVEEDOR, O ASOCIAR UNO QUE YA EXISTE ─────────────
    //
    // Hasta ahora la creación pedía `requireAdmin`: no era que el permiso
    // estuviera mal asignado, es que NO EXISTÍA. Una ubicación que necesitaba un
    // proveedor propio dependía de que un administrador lo diera de alta.
    //
    // EDITAR Y ELIMINAR SIGUEN SIENDO DE ADMIN, y no es un olvido: los datos de
    // `Proveedor` son globales —nombre, CUIT, teléfono, sin `grupoId`— así que
    // editarlos desde un local le cambiaría el proveedor a todas las demás
    // ubicaciones que lo usan. Esa decisión se toma aparte.
    { code: "proveedores.crear", label: "Crear o asociar proveedores", group: "proveedores", order: 20, deprecated: false },
