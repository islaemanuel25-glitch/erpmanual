...
export const PERMISSION_REGISTRY = [
    ...
    // ── LAS FOTOS DE FACTURAS VAN DESENGANCHADAS DE LOS COSTOS ────────────
    //
    // Antes esto se apoyaba en `costos.ver` porque hoy lo tienen justo los
    // mismos. Pero que alguien pueda ver márgenes no tiene por qué darle las
    // facturas del proveedor: son dos cosas distintas que coincidían por
