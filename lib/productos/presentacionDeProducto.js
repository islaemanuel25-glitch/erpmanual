 ...
 * @param {string} p.modoCompraProveedor `ProductoBase.modoCompraProveedor`. Lo
 *   exige `esProductoFiambre`, que es la puerta de `esFiambreFijo`. Sin él, un
 *   fiambre de pieza fija se leería como producto a granel.
...
export function presentacionDeProducto({
  ...
  //    cuenta por piezas.
  //
  // El predicado NO se reescribe acá: sale de `esFiambreFijo`, que ya es el
  // único lugar del repo donde se decide qué es una pieza fija. Escribir
