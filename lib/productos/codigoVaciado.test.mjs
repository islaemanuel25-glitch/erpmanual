...
// producto.
//
// Dos migraciones vacían códigos de texto, con criterios sucesivos:
// 20260810210000 vació 29 sin ninguna venta, y 20260810230000 vacía 45 más —los
// que creó el depósito Y tienen 50 ventas o menos—. Son 74 en total.
//
// Quedan 16 con su código: los 15 del depósito que pasan de 50 ventas, hasta que
// alguien pregunte en el mostrador cuáles se tipean, y 'pollo trozado', de
// Casiano Casas, que por DEC-0006 no se toca.
//
// Vaciarles el código no puede dejarlos sin encontrar ni sin vender. Con la
// segunda migración eso pesa más: los 45 tienen ventas, hasta 48 el que más.
//
...
// y avisan que hay 74 productos que quedarían fuera.
//
...
// codigos-vaciados-deposito-2026-08-10.md (los 45 del depósito).
//
...
// principio y por una palabra del medio.
//
// Ojo con dos que NO sirven de ejemplo: 'xl' y 'BARRATREMBLAY' conservan su
// código, porque pasan de 50 ventas y quedaron afuera del vaciado esperando la
// consulta al mostrador.
...
// Tres de los 74, como quedan DESPUÉS de vaciarles el código. Sus códigos eran
