...
// `lib/hardcodeo/contador.js` que lo usaba de ejemplo. Es la cuarta vez en este
...
const HUERFANOS_DECLARADOS = {
  "--pos-warning":
    "usado en styles/sunmi.css:430 y en 9 estilos inline. Tiene respaldo `#f59e0b`, " +
    "que es lo que se ve en los catorce temas. Ese ámbar da entre 1,91 y 2,15 contra " +
    "el fondo de tarjeta de los NUEVE temas claros, con un mínimo de 4,5. En los cinco " +
    "oscuros da 6,70 a 8,82 y pasa. Son 105 usos de `sunmi-text-warning`.",
  "--pos-accent-fg":
  ...
  "--accent":
    "usado en app/modulos/auditoria-pos-ventas/balances/page.jsx:220 como " +
    "`bg-[var(--accent)]`. SIN RESPALDO: la propiedad queda inválida y el fondo se hereda. " +
    "Falta medir qué se ve hoy.",
  "--border":
    "usado en app/modulos/auditoria-pos-ventas/cajas/page.jsx:95 como " +
    "`border-[var(--border)]`. SIN RESPALDO. Falta medir.",
  "--foreground":
    "usado en app/modulos/auditoria-pos-ventas/turnos/page.jsx:372 como color de texto. " +
    "SIN RESPALDO. Falta medir.",
  "--pos-bg-soft":
    "usado en components/auditoria/BitacoraAuditoria.jsx:216 como `background`. " +
    "SIN RESPALDO. Falta medir.",
  "--sunmi-warning":
    "usado en components/pos-ventas/ModalAperturaTurno.jsx:133 adentro de un " +
    "`color-mix`. SIN RESPALDO. Falta medir.",
};

/** Cuántos son. Aparte, para que sumar uno a la lista se note. */
const CUANTOS_DECLARADOS = 7;
