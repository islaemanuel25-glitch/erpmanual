...
function archivosConPie() {
  // `--others --exclude-standard`: sin eso una pantalla nueva sin commitear no
  // entra y su pie no se revisa. Agujero del 2026-09-14.
  const salida = execSync('git ls-files --cached --others --exclude-standard "*.jsx"', {
    cwd: RAIZ,
    encoding: "utf8",
  });
  return salida
