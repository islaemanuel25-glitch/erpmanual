...
const DEUDA = {
  ...
  "SunmiCardHeader.color": 2,
  // Bajó de 10 a 8 al migrar ModalRol y ModalLocal: el `subtitle` de rol salió
  // con su encabezado viejo, y el de local se conserva a propósito —anotado en
  // el roadmap— pero pasó a declararse una sola vez, en la pieza.
  "SunmiCardHeader.subtitle": 8,
