...
import { whereNotifUsuario, ventanaNotif, VENTANA_NOTIF_DIAS } from "@/lib/notificaciones/whereNotif";

// Re-export: la regla de filtrado vive en el módulo puro whereNotif.js (testeable).
// `ventanaNotif` va por el mismo camino para que el listado y el contador no
// puedan volver a acotar distinto.
export { whereNotifUsuario, ventanaNotif, VENTANA_NOTIF_DIAS };
