 ...
 *
 * Antes de subir se normaliza a centavos: `1050 × 1,3 = 1365,0000000000002` en
 * binario, y sin ese paso el residuo empujaría un precio ya exacto al siguiente
 * múltiplo (1400 → 1500). Un precio es dinero: por debajo del centavo no hay
 * información, solo ruido de punto flotante.
 */
export function redondearA100Arriba(valor) {
...
export function precioDesdeMargen({ costo, margenConfigurado, redondeo100 = false } = {}) {
  ...
  const precioFinal = redondeo100 ? redondearA100Arriba(precioBase) : precioBase;
