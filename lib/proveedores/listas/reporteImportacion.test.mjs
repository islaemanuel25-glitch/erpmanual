...
test("sin código de proveedor la línea lo deja en null y no inventa", () => {
  const [l] = lineasDeActualizados([itemActualizado({ codigosArcor: [] })]);
...
test("un pendiente sale con su motivo y sus filas", () => {
  const items = [
    {
      id: 20, nombre: "MOGUL CONITOS", codigosArcor: ["1003113"], costoActual: 11601,
...
test("un pendiente sin costo propuesto lo deja vacío", () => {
  const items = [{ id: 21, nombre: "X", codigosArcor: [], costoActual: 100, filas: [{ filaExcel: 1, aplicada: false, estado: "FACTOR_DUDOSO" }] }];
...
test("un no informado lleva su motivo fijo", () => {
  const [l] = lineasDeAusentes([
    { id: 30, nombre: "AGUILA 150gr", codigosArcor: ["1012903"], costoActual: 44800, actualizadoEn: "2026-07-01T00:00:00Z" },
  ]);
