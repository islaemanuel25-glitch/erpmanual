...
export const PRESENTACION_ESTADO_IMPORTACION = {
  PARCIALMENTE_APLICADA: {
    etiqueta: "EN CURSO",
    detalle: "Se aplicó una tanda y quedan filas por resolver. Se puede seguir trabajando.",
    tono: "sunmi-badge-warning",
    texto: "sunmi-text-warning",
    simbolo: "◐",
  },
  CANCELADA: {
  ...
  TERMINADA: {
    etiqueta: "TERMINADA",
    detalle:
      "Se cerró a mano: no se puede confirmar ni aplicar nada más. Lo que ya se aplicó sí se puede deshacer.",
    tono: "sunmi-badge-muted",
    texto: "sunmi-text-muted",
    simbolo: "✓",
  },
...
/** Fecha y hora en Argentina, corto. Del helper único. */
