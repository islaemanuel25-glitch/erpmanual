...
export function filaVinculable(fila, importacion) {
  ...
  if (fila.productoBaseId != null) return { ok: false, motivo: MOTIVO_RECHAZO.FILA_YA_MACHEADA };
  if (fila.estado !== ESTADO_LINEA.NO_MACHEADO) {
 ...
 */
export function presentarCandidato(p, { puedeEditarCosto = null } = {}) {
  return {
