...
test("33. los estados de cabecera incluyen CANCELADA", () => {
  // CANCELADA se sumó para poder sacar del flujo una importación equivocada:
  // queda como historial y libera el archivo para volver a subirlo.
