...
import { fechaAR, fechaHoraAR } from "@/lib/fechas/formatearFechaHora";
...
// El PDF se manda por WhatsApp y se archiva: la fecha y la hora que lleve
// impresas son las de Argentina, en 24 horas. Del helper único.
const fecha = (iso) => fechaAR(iso);
